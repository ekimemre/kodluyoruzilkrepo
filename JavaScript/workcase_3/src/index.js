...
let sectionElement = document.querySelector(".section-center");
let containerElement = document.querySelector(".btn-container");
...
/* Butonları Ekleme */
function addButton() {
    containerElement.innerHTML = createButton("All") + " " + createButton("Korea") + " " + createButton("Japan") + " " + createButton("China");
...
// Menude bulunan tum yemeklerin eklenmesi.
function addFoodsAll() {
  sectionElement.innerHTML = "";
  menu.forEach(element => {
    sectionElement.innerHTML += (" " + foodCreator(element));
  });
}

// Sadece Kore yemeklerinin eklenmesi.
